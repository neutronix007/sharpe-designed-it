...
export default function Navbar() {
  ...
  // If the section is already in the DOM (we're on the home page), scroll directly.
  // Otherwise, navigate to the route and let HomePage + App.tsx handle the scroll.
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-white/60">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/neutronix007/PortfolioProjects" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              <Github size={18} />
            </a>
            <a href="https://www.linkedin.com/in/clifford-sharpe/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              <Linkedin size={18} />
            </a>
            ...
            {/* Linktree */}
            <a href="https://linktr.ee/sharpe_designedit" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors opacity-60 hover:opacity-100">
              <img src="https://cdn.simpleicons.org/linktree/ffffff" alt="Linktree" className="w-[18px] h-[18px]" />
            </a>
            <a href="https://cal.com/clifford-sharpe" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              <Calendar size={18} />
            </a>
          </div>
        ...
        {/* Mobile hamburger */}
        <button onClick={() => setIsOpen(!isOpen)} className="md:hidden z-[70] text-white">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex items-center gap-6 opacity-60">
              <a href="https://linktr.ee/sharpe_designedit" target="_blank" rel="noopener noreferrer">
                <img src="https://cdn.simpleicons.org/linktree/ffffff" alt="Linktree" className="w-6 h-6" />
              </a>
              <a href="https://www.linkedin.com/in/clifford-sharpe/" target="_blank" rel="noopener noreferrer">
                <Linkedin size={22} className="text-white" />
              </a>
              <a href="https://www.behance.net/cliffordsharpe" target="_blank" rel="noopener noreferrer">
                <img src="https://cdn.simpleicons.org/behance/ffffff" alt="Behance" className="w-6 h-6" />
              </a>
            </div>
